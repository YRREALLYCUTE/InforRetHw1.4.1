            ...
            <el-tabs type="border-card">
                <el-tab-pane>
                    ...
                    <el-row>
                        ...
                        <el-col :span="11">
                            <el-input v-model="inputStaff" size="medium" placeholder="请输入关键词">
                            </el-input>
                        </el-col>
                                ...
                                <div v-show="condition">
                                    ...
                                    <el-col :offset="1" :span="10" style="margin-left:10px">
                                        <el-radio-group v-model="radioOrder" style="margin-top: 7px">
                                            ...
                                            <el-radio :label="9" size="mini">正常显示</el-radio>
                                        </el-radio-group>
                                    </el-col>
                                </div>
                            </el-collapse-transition>
                    ...
                    <el-row>
                        <div style="margin-top: 15px">
                            <el-collapse-transition>
                                ...
                                <div v-show="condition">
                                    <el-col :span="2" style="text-align: right;margin-top: 4px">
                                        <span style="font-weight: bold;font-size: 15px" >检索范围：</span>
                                    </el-col>
                                    <el-col  :span="4">
...
<script>
    new Vue({
        ...
        data: {
            ...
            displayRule:'',
            displayRuleItems:[],   //显示规则********此处应该与分页处理相关联，故之后需要处理下
            areaRule:'',           //检索范围
            areaRuleItems:[],     //检索范围的选项
        ...
        methods:{
            ...
            simpleSearch:function(inputStaff){
                let vm = this;
                console.log(inputStaff.toString());
                if(inputStaff===''){
